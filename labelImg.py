...
class MainWindow(QMainWindow, WindowMixin):
    ...
    def save_file(self, _value=False):
        ...
        try:
            ...
            with open(saved_path +'_pytorch.txt', 'w') as draft_txt:
                for idx, cont in enumerate(shapes):
                    draft_txt.write(str(cont[0]) + " " + str(cont[1][0][0]) + " " + str(cont[1][0][1]) + " " + str(
                        cont[1][1][0] - cont[1][0][0]) + " " + str(cont[1][2][1] - cont[1][0][1]) + "\n")
